...
<body>
                        ...
                        <c:if test="${ sessionScope.first_name != null}">
                            <div class="dropdown head_btn">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    ...
                                    <li role="presentation"><a role="menuitem" tabindex="-1"  href='examples/MyProductList/test'>My Products</a></li>
        ...
        <div id="search_bar">
            <div class="container">
                ...
                <div class="float_right" id="check_out">
                    <a class="check_out_utility white_link" href="./cart.jsp"><span id=
    ...
    <section>
        <div class="container">
            <div class="cat_header">
                <h2 class="fw_three"><span>Update Product Information</span></h2>
            </div>
        </div>
                            ...
                            <div class=" left_div_small_inner border">
                                <div class="contact_form_container">
                                    <form   class="add_product" id="add_product_form"
                                            ...
                                            method="POST" name="UpdateEditProductInfo" action="./UpdateEditProductInfo">
                                        ...
                                        <div class="form_row">
                                            ...
                                            "product_name form_column float_left required">
                                                ...
                                                <input id="product_name" class="mid_size" name="product_name" type="text" value="${product.product_name }">
                                            </div>

                                            <div class="product_price  form_column float_left required">
                                                <p class="form_label">
                                                Price ($):<span>*</span></p>
                                                <input class="sml_size" type="text" maxlength="6" value="${product.price }" name="price"> .
                                                <input class="xsmall_size" type="text" maxlength="2" name="price_cents">
                                            </div>
                                        ...
                                        <div class="form_row">
                                            ...
                                            "reason form_column ">
                                                <p class="form_label">
                                                Manufacturer:</p>
                                                <input class="mid_size" type="text" maxlength="120" value="${product.brand }" name="manufacturer">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form_row">
                                            <div class="form_column book_details float_left hidden">
                                                <p class="form_label">Publisher:</p><input class="mid_size" name="publisher" value="${product.publisher }"
                                                type="text">
                                            </div>
                                            <div class="form_column book_details float_left hidden">
                                                <p class="form_label">Language:</p><input class="mid_size" name="language" value="${product.language }"
                                                type="text">
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="form_row">
                                            <div class="form_column book_details float_left hidden">
                                                <p class="form_label">ISBN-10:</p><input class="mid_size" name="ISBN_10" value = "${product.ISBN_10 }"
                                                type="text">
                                            </div>
                                            <div class="form_column book_details float_left hidden">
                                                <p class="form_label">ISBN-13:</p><input class="mid_size" name="ISBN_13" value = "${product.ISBN_13}"
                                                type="text">
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="form_row">
                                            <div class="form_column hidden">
                                                <p class="form_label">Page Number:</p><input class="sml_size" name="page_numbers" value="${product.page_numbers }"
                                        ...
                                        <div class="form_row">
                                            <div class="message">
                                                <textarea id="product_description" class="message_area full_width" cols="50"rows="4" name="product_description" placeholder= "${product.product_description }" maxlength="500"></textarea>
                                            </div>
                                            <div class="counter">
                                        ...
                                        <div class="form_row button_row float_right">
                                            <div class="form_column_btn">
                                              ...
                                              <input class="primary_btn" type="submit" value="Edit Product">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>                                   
                                    </form>
    ...
    <ul>
    <li><a href="examples/contact.jsp">Contact Us</a></li>
